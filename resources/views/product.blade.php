	...
	<div class="container">
 	<div class="row">
      ...
      <br>
        ...
        <li class="list-group-item active"><a href=""  style="color:white; text-transform: uppercase;  text-decoration: none;">{{$cate->name}}</a></li>
          @if(count($cate->child)>0)
            @foreach($cate->child as $subcate)
			         <li class="list-group-item"><a class="listgroup" href="{{ route('categories.products', $subcate->id) }}">&nbsp;&nbsp;&nbsp;&nbsp;{{$subcate->name}}</a></li>
            @endforeach
          @endif
        @endforeach
 		...
 		<div class="col-sm-9">
 			<div class="row content">
 				@foreach($products as $product)
					<div class="col-sm-3 khoi1 {{$product->category->slug}}">
            <a href="{{route('products.show',$product->id)}}">
              <img class="phongto"  src="{{$product->images[0]->path}}" >
            </a>	
		 				<a class="ser" href="#product-{{$product->id}}" data-toggle="modal"><i class="fa fa-cart-plus"></i></i></a>
		 				<a class="cartplus" href="{{route('products.show',$product->id)}}"><i class="fa fa-search"></i></a>
             ...
             <div  class="container-fluid p-y-md">
              <div style="padding-left: 200px;" class="col-lg-12">
                  {{$products->links()}}
              </div>
    </div>
        <br> 
  				...
  				<div class="modal fade" id="product-{{ $product->id }}">
                        ...
                        <form style="margin: 0; box-shadow: unset; border: 0px;" class="form-control" method="POST" action="{{ route('add_to_cart') }}">
                          ...
                          <div class="container">
                            <div class="row">
                                <div class="col-sx-4">
                                  <div class="name">Màu</div>
                                </div>
                                <div class="col-sx-8 select2">
                                  <div class="select">
                                    <select class="js-select" name="color_id" style="margin-left: 5px;">
                          ...
                          <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sx-8 select3">
                                  ...
                                  <input style="margin-left: 34px;margin-top: 49px;" class="inputsl" type="number" name="quantity" min="1" value="1">
                                  <div class="tien1">
                                      <i class=""></i>
                                  </div>
                                </div>  
