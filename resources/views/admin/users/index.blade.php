...
<li class="nav-item nav-item-has-subnav">
  <a href="{{ route('admin.user.index') }}"><i class="ion-ios-calculator-outline"></i>Người dùng</a>
</li>
@endsection
...
<button class="btn" type="submit"><i class="ion-ios-search-strong"></i></button>
  ...
  <div class="container-fluid p-y-md">
    ...
    <br>
    <!-- Card Tabs -->
    <h2 class="section-title">Quản lý người dùng || <a href="{{ route('admin.user.create')}}"> Tạo mới dùng </a></h2>
    <div class="row">
      <div class="col-md-12">
                                          ...
                                          @foreach($users as $user)
                                              <tr>
                                                ...
                                                <td class="text-center">
                                                 ...
                                                 <td class="text-center">
                                                    <div class="btn-group">
                                                        <!-- <a href="" class="btn btn-xs btn-default" data-toggle="tooltip" title="" data-original-title="Xem hóa đơn"><i class="ion-eye"></i></a> -->
                                                        ...
                                                        <form method="POST"  class="frdelete" action="{{ route('admin.user.delete', ['id' => $user->id ])}}" style="display: inline;">
                                                          @csrf
                                                          @method('DELETE')
                                                          <button type="button" class="btn btn-xs btn-default btdelete" data-toggle="tooltip" title="Xóa người dùng này khỏi hệ thống"><i class="ion-close" ></i></button>
                                                        </form>
                                                    </div>
                                                </td>
                                              </tr>
