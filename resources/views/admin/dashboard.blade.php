                ...
                <a class="card" href="javascript:void(0)">
                    <div class="card-block clearfix">
                        <div class="pull-right">
                            <p class="h6 text-muted m-t-0 m-b-xs">
                                Revenue
                            </p>
                        ...
                        <div class="pull-left m-r">
                            <span class="img-avatar img-avatar-48 bg-blue bg-inverse">
                                <i class="ion-ios-bell fa-1-5x">
                                </i>
                            </span>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <a class="card bg-green bg-inverse" href="javascript:void(0)">
                    <div class="card-block clearfix">
                        ...
                        <div class="pull-left m-r">
                            <span class="img-avatar img-avatar-48 bg-gray-light-o">
                                <i class="ion-ios-people fa-1-5x">
                                </i>
                            </span>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <a class="card bg-blue bg-inverse" href="javascript:void(0)">
                    <div class="card-block clearfix">
                        ...
                        <div class="pull-left m-r">
                            <span class="img-avatar img-avatar-48 bg-gray-light-o">
                                <i class="ion-ios-speedometer fa-1-5x">
                                </i>
                            </span>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-block p-b-0 bg-blue bg-inverse">
                        ...
                        <div style="height: 200px;">
                            <canvas class="js-chartjs-lines1">
                            </canvas>
                        </div>
                    </div>
                    <div class="card-block">
                        <div class="row">
                            <div class="col-xs-6 col-lg-3 b-r">
                                ...
                                <p class="h3 m-t-0 m-b-md">
                                    +214.22
                                </p>
                                <div class="progress progress-mini m-b-sm">
                                    <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="76" class="progress-bar progress-bar-green" role="progressbar" style="width: 76%">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-lg-3 b-r visible-lg">
                                ...
                                <div class="progress progress-mini m-b-sm">
                                    <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="84" class="progress-bar progress-bar-green" role="progressbar" style="width: 84%">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-lg-3 b-r visible-lg">
                                ...
                                <div class="progress progress-mini m-b-sm">
                                    <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="74" class="progress-bar progress-bar-green" role="progressbar" style="width: 74%">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-lg-3">
                                ...
                                <div class="progress progress-mini m-b-sm">
                                    <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="90" class="progress-bar progress-bar-green" role="progressbar" style="width: 90%">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-block p-b-0">
                        <div style="height: 268px;">
                            <canvas class="js-chartjs-lines2">
                            </canvas>
                        </div>
                    </div>
                    <div class="card-block text-center">
                        <span class="label bg-green m-r-xs">
                            Statistics
                            <i class="ion-connection-bars">
                            </i>
                        </span>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <div style="height: 238px;">
                            <canvas class="js-chartjs-lines3">
                            </canvas>
                        </div>
                    </div>
                    <div class="card-block text-center">
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-block bg-purple p-x-0 p-b-0">
                        ...
                        <div class="js-flot-live" style="height: 207px;">
                        </div>
                    </div>
                </div>
                <!-- .card -->
